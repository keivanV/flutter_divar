        ...
        builder: (context) {
          ...
          return FutureBuilder(
            ...
            builder: (context, snapshot) {
              print('FutureBuilder snapshot: $snapshot'); // لاگ برای دیباگ
                  ...
                  home: Scaffold(
                    body: Center(
                      child: CircularProgressIndicator(
                        color: Colors.red, // رنگ قرمز دیوار
                      ),
                    ),
                  ),
                );
              ...
              print('isLoggedIn: $isLoggedIn'); // لاگ برای دیباگ
              return MaterialApp(
                title: 'دیوار',
                theme: appTheme,
                ...
                routes: {
                  ...
                  '/ad_details': (context) =>
                      const AdDetailsScreen(), // Ad details screen
                },
              );
            },
          );
